...
TypeKind.NULL_PTR = TypeKind(24)
TypeKind.OVERLOAD = TypeKind(25)
TypeKind.DEPENDENT = TypeKind(26)
TypeKind.OBJC_ID = TypeKind(27)
TypeKind.OBJC_CLASS = TypeKind(28)
TypeKind.OBJC_SEL = TypeKind(29)
TypeKind.COMPLEX = TypeKind(100)
TypeKind.POINTER = TypeKind(101)
TypeKind.BLOCK_POINTER = TypeKind(102)
TypeKind.LVALUE_REFERENCE = TypeKind(103)
TypeKind.RVALUE_REFERENCE = TypeKind(104)
TypeKind.RECORD = TypeKind(105)
TypeKind.ENUM = TypeKind(106)
TypeKind.TYPEDEF = TypeKind(107)
TypeKind.OBJC_INTERFACE = TypeKind(108)
TypeKind.OBJC_OBJECT_POINTER = TypeKind(109)
TypeKind.FUNCTION_NO_PROTO = TypeKind(110)
TypeKind.FUNCTION_PROTO = TypeKind(111)
TypeKind.CONSTANT_ARRAY = TypeKind(112)
